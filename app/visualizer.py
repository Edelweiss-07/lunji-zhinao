...
def generate_image_analysis_viz(llm_response: str):
    ...
    valid_dev = [dev_vals[i] for i in valid_idx]
    valid_units = [unit_vals[i] for i in valid_idx]
...
def export_csv() -> str:
    ...
    lines = ["时间,参数,负载(%),实测值,单位,KB基准值,偏差,是否异常"]
